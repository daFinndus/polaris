...
function Supported() {
  return (
    <div className="relative flex w-screen items-center justify-center bg-background">
      <div
        className={
          "laptop:flex laptop:flex-col hidden gap-y-2 laptop:fixed laptop:top-4 laptop:right-4"
        }
      >
        <ColorModeButton />
        <NewsPageButton />
      ...
      <div className="flex items-start justify-center font-sans tablet:p-8 laptop:px-32">
        ...
        <div className="grid grid-cols-1 gap-4 p-4 laptop:hidden">
          <div
            className={
              "flex gap-x-2 notebook:fixed notebook:flex-col notebook:gap-y-2 notebook:top-4 notebook:right-4"
            }
          >
            <ColorModeButton />
            <NewsPageButton />
