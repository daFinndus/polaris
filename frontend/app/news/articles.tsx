...
export default function Articles() {
  ...
  return (
    <div
      className={
        "flex flex-col w-full notebook:px-4 py-4 justify-center items-center"
      }
    >
      <div
        className={
          "flex flex-col notebook:flex-row gap-y-2 notebook:gap-y-0 notebook:gap-x-4 w-full smartphone:px-4 mt-4 mb-8 items-center justify-center"
        }
      >
      ...
      <div
        className={
          "grid gap-y-8 gap-x-4 notebook:grid-cols-2 laptop:grid-cols-3 gap-4"
        }
      >
        {loading
...
const ArticleCard = ({ article }: { article: Article }) => {
  ...
  return (
    <CardContainer className="inter-var h-min p-0 m-0">
      <CardBody className="bg-background-light relative shadow-lg hover:shadow-xl group/card border-background-lighter rounded-xl px-4 border">
        ...
        <CardItem translateZ={100} translateY={10} className={"w-full"}>
          <CardContent>
            ...
            <p
              className={
                "absolute bg-background-light p-2 top-24 max-w-28 whitespace-nowrap font-bold text-sm overflow-hidden text-ellipsis"
              }
            >
              {article.source.name}
            </p>
            <p
              className={
                "absolute bg-background-light p-2 top-24 right-4 font-bold text-sm"
              }
            >
...
const ArticleCardSkeleton = () => {
  return (
    <CardContainer className="inter-var h-min p-0 m-0">
      <CardBody className="flex flex-col items-center bg-background-light shadow-lg hover:shadow-xl group/card border-background-lighter rounded-xl px-4 border">
