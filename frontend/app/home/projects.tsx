...
function Project({
  ...
  return (
    <CarouselItem className={"basis-1/3"}>
      <Image
        className={
          "m-0 flex h-24 w-[172px] items-center justify-center rounded-lg bg-background p-0 text-center text-xs font-bold"
        }
        src={src}
        alt={alt}
        width={width}
  ...
  return (
    ...
    >
      ...
      <div className={"flex flex-col items-center"}>
        <div
          className={
            "flex w-full flex-row items-center justify-center overflow-hidden"
          }
        >
          <Carousel
            opts={{
