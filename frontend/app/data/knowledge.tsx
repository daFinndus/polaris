...
export const development: Technology[] = [
    {
        ...
        name: "Python",
        content:
            "Python is a versatile programming language I use for scripting, data analysis, and building prototypes.",
...
export const cybersecurity: Method[] = [
    {
        ...
        content:
            "I am able to identify open ports, services, and vulnerabilities on networked systems using tools like Nmap.",
    },
    {
        Icon: GiBrute,
        name: "Directory Fuzzing",
        content:
            "I can discover hidden directories and files on web servers using tools like DirBuster, Gobuster or Ffuf.",
    },
    {
        Icon: SiBurpsuite,
        name: "Web Application Testing",
        content:
            "I know how to analyze web applications for security vulnerabilities using tools like Burp Suite.",
    },
    {
