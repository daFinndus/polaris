  ...
  return (
    ...
    >
      <CardContainer className={"py-4"}>
        <CardBody
          className={
            "shadow-background-lighter relative h-full w-full shadow-lg"
          }
        >
      ...
      <div
        className={
          "flex h-full w-full flex-col items-start justify-start text-start"
        }
      >
        <p className={"mb-2 text-base font-bold"}>{project.name}</p>
        <p className={"text-primary-darker mb-2 text-justify text-sm"}>
          {project.description}
        </p>
        ...
        <div className={"mt-auto mb-2 flex w-full items-end gap-x-2"}>
          {project.url ? (
            <Link href={project.url} className={"w-1/2"} target={"_blank"}>
              <Button
                className={
                  "bg-color hover:text-color w-full text-white hover:bg-white"
                }
              >
                Sourcecode
              </Button>
            ...
            <Button
              className={"bg-background-lighter text-primary-darker w-1/2"}
              disabled
            >
              No Sourcecode
            </Button>
          ...
          {project.demo ? (
            <Link href={project.demo} className={"w-1/2"} target={"_blank"}>
              <Button
                className={
                  "h w-full bg-black text-white hover:bg-white hover:text-black"
                }
              >
                Demo
              </Button>
