...
const Supported = () => {
  ...
  return (
    <div
      className={
        "relative flex h-screen w-screen flex-col items-center justify-center text-center"
      }
    >
      <div
        className={"tablet:flex absolute top-4 right-4 hidden flex-col gap-y-2"}
      >
        <HomeButton />
        <ColorModeButton />
      </div>
      <div
        className={
          "tablet:hidden mt-4 -mb-2 flex w-78 items-center justify-center gap-x-2"
        }
      >
        <HomeButton />
        <ColorModeButton />
